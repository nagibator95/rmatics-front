import {TableType, ITableUser} from './monitor.types';
...
export const totalScoreCompare = (type: TableType, reverse?: boolean) => (
    a: ITableUser,
    b: ITableUser,
) => {
    const r = reverse ? -1 : 1;
...
export const nameCompare = (reverse?: boolean) => (a: ITableUser, b: ITableUser) => {
    const r = reverse ? -1 : 1;
...
export const problemCompare = (problemId: number, reverse?: boolean) => (
    a: ITableUser,
    b: ITableUser,
) => {
    const r = reverse ? -1 : 1;
